    ...
    try {
      const analysis = await claudeAnalyzer.analyze(session, {
        ...
        baseUrl: tier === 'premium'
          ? 'https://api.markuprplus.com/v1'  // Cloudflare Worker proxy
...
---
*Generated by [markuprx](https://markuprplus.com) with AI analysis*
```
...
```
User App  -->  https://api.markuprplus.com/v1/messages
                      |
                Cloudflare Worker
                      |
