      ...
      case 'anthropic':
        return (
          <ApiKeyStep
            ...
            helpText={
              <>
                Choose from installed coding-agent CLIs—including Codex, Claude Code, GitHub Copilot, OpenCode, Cursor, Qwen Code, Goose, Amp, Kiro, and Aider—or use Ollama, LM Studio, Anthropic API, or Local Rules later in Settings {'>'} Advanced. If you want Anthropic API, create a key at{' '}
                <a
