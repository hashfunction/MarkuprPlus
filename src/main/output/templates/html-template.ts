...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src data: file:; style-src 'unsafe-inline'; font-src data:">
  <meta name="generator" content="${PUBLIC_BRAND_NAME}">
...
<body>
  <div class="container">
    ...
    <footer>
      Generated by <a href="${PUBLIC_WEBSITE_URL}" target="_blank" rel="noopener">${PUBLIC_BRAND_NAME}${version ? ` v${escapeHtml(version)}` : ''}</a>
    </footer>
  </div>
</body>
</html>`;
